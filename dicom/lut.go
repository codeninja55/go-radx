...
// descriptor's negative value is preserved. GetInt already returns signed int64 for
// both, so the three values are read directly.
...
// would carry US, not OW, for this element in practice).
