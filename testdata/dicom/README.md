...
| `SC_rgb_jls_lossy_sample.dcm` | JPEG-LS Near-Lossless (`1.2.840.10008.1.2.4.81`) | pydicom `SC_*` family; 100x100 RGB 8-bit, sample-interleaved | MIT (pydicom) | JPEG-LS sample-interleaved RGB decode to DICOM planar config 0 (Increment 6c) |
