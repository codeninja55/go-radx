...
type ClaimResponseItemDetailSubDetail struct {
	...
	ReviewOutcome *ClaimResponseItemDetailSubDetailReviewOutcome `json:"reviewOutcome,omitempty"`
...
type ClaimResponseItemDetail struct {
	...
	ReviewOutcome *ClaimResponseItemDetailReviewOutcome `json:"reviewOutcome,omitempty"`
...
type ClaimResponseAddItemDetailSubDetail struct {
	...
	ReviewOutcome *ClaimResponseAddItemDetailSubDetailReviewOutcome `json:"reviewOutcome,omitempty"`
...
type ClaimResponseAddItemDetail struct {
	...
	ReviewOutcome *ClaimResponseAddItemDetailReviewOutcome `json:"reviewOutcome,omitempty"`
...
type ClaimResponseAddItem struct {
	...
	ReviewOutcome *ClaimResponseAddItemReviewOutcome `json:"reviewOutcome,omitempty"`
