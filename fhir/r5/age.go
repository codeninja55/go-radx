...
// Age is the generated FHIR Age datatype.
type Age struct {
	Element
...
func (v Age) MarshalJSON() ([]byte, error) {
	...
	return marshalAgeSiblings(&v, encoded)
}

// marshalAgeSiblings appends the primitive "_field" siblings to the
...
func marshalAgeSiblings(v *Age, encoded []byte) ([]byte, error) {
