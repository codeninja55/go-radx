...
// SimpleQuantity is the generated FHIR SimpleQuantity datatype.
...
func (v SimpleQuantity) MarshalJSON() ([]byte, error) {
	type alias SimpleQuantity
	encoded, err := json.Marshal(alias(v))
	if err != nil {
		return nil, err
	}
	return marshalSimpleQuantitySiblings(&v, encoded)
}

// marshalSimpleQuantitySiblings appends the primitive "_field" siblings to the
...
func marshalSimpleQuantitySiblings(v *SimpleQuantity, encoded []byte) ([]byte, error) {
...
func (v *SimpleQuantity) UnmarshalJSON(data []byte) error {
