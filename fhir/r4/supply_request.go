...
// SupplyRequestItem is the sealed value interface for the item[x]
// choice group. It is implemented only by this package's branch types — the named
// datatype structs and the release primitive wrappers — through the unexported
// isSupplyRequestItem marker, so a built-in scalar can never satisfy it and the
// branch set stays closed.
type SupplyRequestItem interface{ isSupplyRequestItem() }

func (CodeableConcept) isSupplyRequestItem() {}
func (Reference) isSupplyRequestItem()       {}

// Item returns the value set in the item[x] choice
// group, or (nil, false) when no branch is set. The returned value is one of the
// branch types; a type switch recovers which branch was chosen.
func (r *SupplyRequest) Item() (SupplyRequestItem, bool) {
	switch {
...
func (r *SupplyRequest) SetItemCodeableConcept(v CodeableConcept) {
...
// value and marshals exactly one suffixed key.
func (r *SupplyRequest) SetItemReference(v Reference) {
	r.ItemCodeableConcept = nil
	r.ItemReference = nil
	r.ItemReference = &v
}
