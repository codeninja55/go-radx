...
func (FHIRDateTime) isActivityDefinitionTiming() {}
func (Age) isActivityDefinitionTiming()          {}
func (Period) isActivityDefinitionTiming()       {}
...
// release primitive wrapper that carries the isActivityDefinitionTiming marker; the built-in
// scalar cannot) and clears every other branch, so the group holds at most one
// value and marshals exactly one suffixed key.
func (r *ActivityDefinition) SetTimingDateTime(v FHIRDateTime) {
	r.TimingTiming = nil
	r.TimingDateTime = nil
	r.TimingAge = nil
	r.TimingPeriod = nil
...
// value and marshals exactly one suffixed key.
func (r *ActivityDefinition) SetTimingPeriod(v Period) {
	r.TimingTiming = nil
	r.TimingDateTime = nil
	r.TimingAge = nil
	r.TimingPeriod = nil
