...
func (FHIRString) isCommunicationPayloadContent() {}
...
// release primitive wrapper that carries the isCommunicationPayloadContent marker; the built-in
// scalar cannot) and clears every other branch, so the group holds at most one
// value and marshals exactly one suffixed key.
func (r *CommunicationPayload) SetContentString(v FHIRString) {
	r.ContentString = nil
