...
// Duration is the generated FHIR Duration datatype.
...
func (v Duration) MarshalJSON() ([]byte, error) {
	...
	return marshalDurationSiblings(&v, encoded)
}

// marshalDurationSiblings appends the primitive "_field" siblings to the
...
func marshalDurationSiblings(v *Duration, encoded []byte) ([]byte, error) {
