...
// Quantity is the generated FHIR Quantity datatype.
...
func (v Quantity) MarshalJSON() ([]byte, error) {
	...
	return marshalQuantitySiblings(&v, encoded)
}

// marshalQuantitySiblings appends the primitive "_field" siblings to the
...
func marshalQuantitySiblings(v *Quantity, encoded []byte) ([]byte, error) {
