...
// Count is the generated FHIR Count datatype.
type Count struct {
	Element
...
func (v Count) MarshalJSON() ([]byte, error) {
	...
	return marshalCountSiblings(&v, encoded)
}

// marshalCountSiblings appends the primitive "_field" siblings to the
...
func marshalCountSiblings(v *Count, encoded []byte) ([]byte, error) {
